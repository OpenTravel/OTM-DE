...
public class Library_FunctionTests extends BaseProjectTest {
	...
	public void LN_moveComplexTests() throws LibrarySaveException {
		// Given
		LibraryNode moveFrom = ml.createNewLibrary_Empty(defaultProject.getNamespace() + "/Test/One", "MoveFrom",
				defaultProject);
	...
	public void importNode_Tests() throws LibrarySaveException {
		...
		LibraryNode moveFrom = ml.createNewLibrary_Empty(testProject.getNamespace() + "/Test/From", "MoveFrom",
				testProject);
	...
	public void LN_addMemberTests() {
		...
		LibraryNode ln_inChain = ml.createNewLibrary_Empty("http://www.test.com/test1c", "testManaged", defaultProject);
