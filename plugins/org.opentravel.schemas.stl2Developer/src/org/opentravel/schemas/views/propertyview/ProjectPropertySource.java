...
public class ProjectPropertySource extends AbstractPropertySource<ProjectNode> {
	...
	enum ProjectProperties implements PropertyInfo {
		NAME(Messages.getString("view.properties.library.label.name"), CAT_BASIC, Messages
				...
				.getString("view.properties.library.tooltip.path")), MANAGED_ROOT(Messages
				...
				.getString("view.properties.library.tooltip.extension")), NAMESPACE(Messages
				.getString("view.properties.library.label.namespace"), CAT_NAMESPACE, Messages
				.getString("view.properties.library.tooltip.namespace"));
	...
	private Collection<String> getNamespaces() {
		...
		for (final String namespace : OtmRegistry.getMainController().getRepositoryController().getRootNamespaces()) {
	...
	abstract class ProjectPropertySetter extends EnumPropertySetter {
		...
		private boolean isDefaultProject(ProjectNode project) {
			return project.equals(OtmRegistry.getMainController().getProjectController().getDefaultProject());
		}
