...
public class LifeCycleAction extends OtmAbstractAction {
	...
	private static StringProperties propsDefault = new ExternalizedStringProperties("action.library.lifecycle.review");
	private static StringProperties propsFinal = new ExternalizedStringProperties("action.library.lifecycle.finalize");
	private static StringProperties propsReview = new ExternalizedStringProperties("action.library.lifecycle.review");
	private static StringProperties propsObsolete = new ExternalizedStringProperties(
			"action.library.lifecycle.obsolete");
