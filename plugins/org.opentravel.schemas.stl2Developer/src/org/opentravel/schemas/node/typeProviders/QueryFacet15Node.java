 ...
 * 
 */
public class QueryFacet15Node extends ContextualFacet15Node {

	// wizard and Testing constructor
	public QueryFacet15Node() {
		super(new TLContextualFacet());
		getTLModelObject().setFacetType(TLFacetType.QUERY);
	}

	public QueryFacet15Node(TLContextualFacet tlObj) {
		super(tlObj);
	}

	@Override
	public boolean canOwn(AbstractContextualFacet targetCF) {
		if (targetCF instanceof QueryFacet15Node)
