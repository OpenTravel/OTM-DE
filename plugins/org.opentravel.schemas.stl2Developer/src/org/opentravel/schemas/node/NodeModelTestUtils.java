...
/**
 * These methods test the node model tree. They are safe in that all logic is encapsulated in a
 * LOGGER.debug statement.
 * 
 * @author Dave Hollander
 * 
 *         OBSOLETE - Node_Tests covers the same content requirements plus more.
 */
