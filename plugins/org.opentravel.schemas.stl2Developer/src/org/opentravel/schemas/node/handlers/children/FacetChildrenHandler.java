...
public class FacetChildrenHandler extends CachingChildrenHandler<Node, FacetNode> {
	private static final Logger LOGGER = LoggerFactory.getLogger(FacetChildrenHandler.class);

	public FacetChildrenHandler(final FacetNode obj) {
		super(obj);
	}
