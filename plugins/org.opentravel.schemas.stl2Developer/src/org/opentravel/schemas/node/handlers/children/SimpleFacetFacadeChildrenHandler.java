...
public class SimpleFacetFacadeChildrenHandler extends CachingChildrenHandler<Node, SimpleFacetFacadeNode> {
	private final static Logger LOGGER = LoggerFactory.getLogger(SimpleFacetFacadeChildrenHandler.class);

	public SimpleFacetFacadeChildrenHandler(SimpleFacetFacadeNode obj) {
		super(obj);
	}
