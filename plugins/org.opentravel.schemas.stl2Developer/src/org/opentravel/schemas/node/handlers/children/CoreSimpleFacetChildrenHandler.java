...
public class CoreSimpleFacetChildrenHandler extends StaticChildrenHandler<Node, CoreSimpleFacetNode> {
	// public class CoreSimpleFacetChildrenHandler extends CachingChildrenHandler<Node, CoreSimpleFacetNode> {
	private final static Logger LOGGER = LoggerFactory.getLogger(CoreSimpleFacetChildrenHandler.class);

	/**
	 * @param core_SimpleFacetFacadeNode
	 */
	public CoreSimpleFacetChildrenHandler(CoreSimpleFacetNode obj) {
		super(obj);
		initChildren();
	}
