...
public class NewLibraryWizardPage extends WizardPage {
    ...
    protected NewLibraryWizardPage(final String pageName, final String title,
            final LibraryNode library, final String baseNS, final FormValidator validator) {
        super(pageName, title, null);
        this.library = library;
        this.validator = validator;
        this.baseNS = baseNS;
        nsHandler = library.getNsHandler();
    }
    ...
    public void createControl(final Composite parent) {
        ...
        fileButton.addSelectionListener(new SelectionListener() {
            ...
            public void widgetSelected(final SelectionEvent e) {
                ...
                fd.setFilterPath(library.getPath());
        ...
        baseNamespaceLabel.setToolTipText(Messages
                .getString("view.properties.library.tooltip.managedRoot"));
        ...
        library.setNamespace(library.getNsHandler().createValidNamespace(baseNS,
                InitialVersionNumber)); // put
        // ns
        ...
        prefixText.addModifyListener(new ModifyListener() {
            ...
            @Override
            public void modifyText(final ModifyEvent e) {
                library.setNSPrefix(prefixText.getText());
                validate();
            }
        });
        ...
        commentsText.addModifyListener(new ModifyListener() {
            ...
            @Override
            public void modifyText(final ModifyEvent e) {
                library.setComments(commentsText.getText());
            }
    ...
    private void updateNS_Fields() {
        final String ns = library.getNsHandler().createValidNamespace(namespaceText.getText(),
                nsExtText.getText(), versionText.getText());
        library.setNamespace(ns);
        final String prefix = nsHandler.getPrefix(ns);
        if (prefix != null && !prefix.isEmpty()) {
            library.setNSPrefix(prefix);
    ...
    private void validate() {
        ...
        if (fileAlreadyExists(library.getPath())) {
