...
public class XSD2OTMWizard extends Wizard {
    ...
    public XSD2OTMWizard(RepositoryPage repositoryPage) {
        this.newRepositoryPage = repositoryPage;
        setWindowTitle(Messages.getString("wizard.repository.new.title"));
    }

    public static XSD2OTMWizard createNewRepositoryWizard() {
        return new XSD2OTMWizard(new RepositoryPage());
    }

    public static XSD2OTMWizard createChangeCredentialWizard(RepositoryNode repository) {
        XSD2OTMWizard wizard = new XSD2OTMWizard(new ChangeCredentialsPage(repository));
