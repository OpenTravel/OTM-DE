...
public class NewLibraryValidator implements FormValidator {
	...
	public void validate() throws ValidationException {
		...
		throwExceptionIfEmpty(library.getPath(), unacceptable, Messages.getString("library.validation.url"));

		throwExceptionIfEmpty(library.getName(), unacceptable, Messages.getString("library.validation.name"));
