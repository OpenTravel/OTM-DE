...
public class SimpleTypeNode extends ComponentNode implements SimpleComponentInterface, TypeUser {
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.node.ComponentNode#hasNavChildren()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.node.Node#getTLBaseType()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.node.Node#isTypeProvider()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.node.Node#setAssignedType(com.sabre.schemas.node.Node)
     * 
     * @see com.sabre.schemas.types.TypeUser#setAssignedType()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.node.Node#getAssignedType()
     */
    @Override
