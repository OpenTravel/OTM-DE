...
public class XsdNode extends ComponentNode implements SimpleComponentInterface {
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.node.ComponentNode#hasNavChildrenWithProperties()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.node.ComponentNode#isCoreObject()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.node.Node#isEnumeration()
     */
    @Override
    ...
    // * (non-Javadoc)
    // *
    // * @see com.sabre.schemas.node.Node#isEnumerationOpen()
    // */
    // @Override
    ...
    // * (non-Javadoc)
    // *
    // * @see com.sabre.schemas.node.Node#isEnumerationClosed()
    // */
    // @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.node.ComponentNode#isSimpleType()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.node.ComponentNode#isBusinessObject()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.node.Node#isValueWithAttributes()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.node.SimpleComponentInterface#isSimpleTypeProvider()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.node.SimpleComponentInterface#getBaseType()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.node.SimpleComponentInterface#getTLOjbect()
     */
    @Override
