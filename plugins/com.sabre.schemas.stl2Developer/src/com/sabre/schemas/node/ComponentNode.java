...
public class ComponentNode extends Node implements TypeProvider {
    ...
    /**
     * Inherited nodes are not assigned a type class. If they were the where-used count would be
     * wrong.
     * 
    ...
    /**
     * Top Level component node construction. Create model object, set name and description, set TL
     * library member
     * 
     * @param tlModelObject
    ...
    /**
     * Create a component node for a <b>non</b>-top-level model element. Only creates node and sets
    ...
    /**
     * Create nodes for all of the children of the model object in this node. Also creates nodes for
     * GUI only synthetic children such as roles and aliases.
     * 
     */
     ...
     * Actual node where the inherited child is declared.
     * 
     * @return type inherited from or null if no inheritance. Note, Open Enumerations have an
     *         inherited attribute but null for inherits from.
     */
            ...
            for (final Object obj : inheritedMOChildren) {
                ...
                if (nn != null) {
                    ...
                    if (obj instanceof TLModelElement) {
                        ...
                        nn.inheritsFrom = searchRoot.findNode(((TLModelElement) obj)
    ...
    /**
     * Create a new component node and model object and link it to <i>this</i>library's Complex or
     * Simple Root node. Used for creating model objects from nodes constructed by GUI otmHandlers
     * and wizards.
     * 
    ...
    /**
     * Test this node against those in the parentNode to and return true if the name is unique
     * within its parent and inherited parent. NOTE: does not check other facets!
     * 
     * @return
     */
    ...
    /**
     * Create aliases for all complex properties of this object that have the same type. Used in
     * importing from XSD.
     */
    public void createAliasesForProperties() {

        Map<ComponentNode, List<Node>> typeMap = new HashMap<ComponentNode, List<Node>>(
                getDescendants().size());
        List<Node> list;
    ...
    /**
     * Create a new object in a minor version library. Creates an empty copy of this node's owner.
     * Adds the new node to the owner's chain head library.
     * 
    ...
    /**
     * Create a new object in a patch version library. Creates an empty extension point facet. Adds
     * the new node to the owner's chain head library.
     * 
    ...
    /**
     * Change Node to VWA_Node using properties of this node as templates. Create new node and
     * assign type users. Replace this node in the library. Removes type users from old node and its
     * children. NOTES: 1) Does <b>not</b> delete this node.
     * 
     */
    ...
    /**
     * Replace this node with a newly created business object. Anywhere this node is used as a type
     * is changed to use the new node. This node is removed from its library and the new business
     * object is added.
     * 
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.types.TypeProvider#isAssignableToSimple()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.types.TypeProvider#isAssignableToVWA()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.types.TypeProvider#isAssignableToElementRef()
     */
    @Override
    ...
    /**
     * Add a new property from a Drag-and-Drop action. If version rules require, a new component
     * (extension point facet) is created.
     * 
     * @param isCopy
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.types.TypeProvider#getWhereUsedAsType()
     * 
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.node.Node#getWhereUsed()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.types.TypeProvider#typeUsersCount()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.node.Node#getComponentUsersCount()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.types.TypeProvider#getTypeOwner()
     */
    @Override
