...
public class OtmTextFields extends OtmWidgets {
    ...
    public Text formatTextBlock(final Composite container, final int nCols) {
        ...
        description.setText("");
        description
                .setToolTipText("Description of the new component. Describe the object it represents.");
    ...
    public Text formatTextField(final FormToolkit toolkit, final Composite parent,
            final int[] properties) {
        return formatTextField(toolkit, parent, properties, SWT.SINGLE);
    }

    public Text formatTextField(final FormToolkit toolkit, final Composite parent,
            final int[] properties, int style) {
        return formatTextField(toolkit, parent, properties, style, DEFAULT_VSPAN);
    }

    public Text formatTextField(final FormToolkit toolkit, final Composite parent,
            final int[] properties, int style, int vSpan) {
    ...
    private Text formatTextField(final Text text, final Label label, final int[] properties,
            final int span) {
