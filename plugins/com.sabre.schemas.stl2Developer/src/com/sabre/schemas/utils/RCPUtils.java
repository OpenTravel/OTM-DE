...
public class RCPUtils {
    ...
    public static boolean executeCommand(String id, Event event, IWorkbenchPartSite site)
     ...
     * 
     * @param site
     *            - a service locator that is most appropriate for this contribution. Typically the
     *            local IWorkbenchWindow or IWorkbenchPartSite will be sufficient. Must not be null.
     * @param commandId
     *            - the defined command.
     * @param label
     *            - A label for this item. For null value the label from command definition will be
     *            used.
     * @param tooltip
     *            - A tooltip for this item. For null value the description from command definition
     *            will be used.
     * @param icon
     *            - An icon for this item. May be null.
     * @return A contribution item represents a contribution to a shared UI resource such as a menu
     *         or tool bar for defined command.
     * 
     * @throws IllegalStateException
     *             if given command id is not defined.
     */
    public static IContributionItem createCommandContributionItem(IServiceLocator site,
            String commandId, String label, String tooltip, ImageDescriptor icon) {
        ...
        try {
            CommandContributionItemParameter p = new CommandContributionItemParameter(site, "",
                    commandId, SWT.PUSH);
            if (label == null) {
                p.label = cmd.getName();
            } else {
            ...
            throw new IllegalStateException("Command nod defined: " + commandId);
        }
    }
    ...
    /**
     * Trying to find view from active workbench. If view is not created then this method will force
     * initialization of given view.
     * 
     * @param id
     *            - view id
