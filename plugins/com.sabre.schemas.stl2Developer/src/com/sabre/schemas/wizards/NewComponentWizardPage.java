...
public class NewComponentWizardPage extends WizardPage {
    ...
    private static ComponentNodeType[] complexComponentList = { ComponentNodeType.BUSINESS,
            ComponentNodeType.CORE, ComponentNodeType.VWA, ComponentNodeType.OPEN_ENUM };
    private static ComponentNodeType[] simpleComponentList = { ComponentNodeType.SIMPLE,
            ComponentNodeType.CLOSED_ENUM };

    private static ComponentNodeType[] PatchComponentList = { ComponentNodeType.SIMPLE,
            ComponentNodeType.CLOSED_ENUM, ComponentNodeType.EXTENSION_POINT };

    private static ComponentNodeType[] componentList = { ComponentNodeType.BUSINESS,
            ComponentNodeType.CORE, ComponentNodeType.VWA, ComponentNodeType.OPEN_ENUM,
            ComponentNodeType.CLOSED_ENUM, ComponentNodeType.SIMPLE,
    ...
    protected NewComponentWizardPage(final String pageName, final String title,
            final ImageDescriptor titleImage, Node node) {
    ...
    public void createControl(final Composite parent) {
        ...
        libraryField.setText(targetNode.getLibrary().getLabel() + " ["
                + targetNode.getLibrary().getVersion() + " ]");
        ...
        if (targetNode.getLibrary().getEditStatus().equals(NodeEditStatus.PATCH)) {
            ...
            libraryField
                    .setToolTipText(Messages.getString("wizard.newObject.select.tooltip.patch"));
        }
    ...
    private void postCommonFields() {
        ...
        newDescription.setToolTipText(Messages
                .getString("wizard.newObject.descriptionField.tooltip"));
        ...
        public void modifyText(final ModifyEvent e) {
            if (e.widget instanceof Combo) {
                if (combo.getItem(combo.getSelectionIndex()).equals(
                        ComponentNodeType.EXTENSION_POINT.getDescription())) {
                    // if
