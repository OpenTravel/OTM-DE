...
import com.sabre.schemas.trees.library.LibraryTreeWithPropertiesContentProvider;
...
public class NewPropertiesWizardPage extends WizardPage {
     ...
     */
    protected NewPropertiesWizardPage(final String pageName, final String title,
            final FormValidator validator, final List<PropertyNodeType> enabledTypes,
            final LibraryNode library, final Node scope) {
    ...
    public void createControl(final Composite parent) {
        ...
        copyAction
                .setToolTipText("Copy selected properties from left tree to the list of new properties");
        ...
        propertyCombo = WidgetFactory.createCombo(rightPanel, SWT.DROP_DOWN | SWT.V_SCROLL
                | SWT.READ_ONLY);
    ...
    private PropertyNode newProperty(final PropertyNode o) {
        ...
        final PropertyNode copy = (PropertyNode) NodeFactory.newComponentMember(editedFacet,
                o.cloneTLObj());
    ...
    private void newPropertyFromType(final Node node) {
        if (node.isAssignable()) {
            ...
            String adjusted = NodeNameUtils.adjustCaseOfName(newProperty.getPropertyType(),
                    node.getName());
    ...
    private void chooseTLType() {
        ...
        if (wizard.getSelection() != null
                && (getSelectedNode().getName().startsWith("Property") || getSelectedNode()
                        .getName().startsWith("property")))
    ...
    public void updateView() {
        ...
        if (selectedNode != null) {
            ...
            typeText.setText(modelObject == null || modelObject.getTLType() == null ? ""
                    : modelObject.getTLType().getLocalName());
    ...
    private void updateTypeButtonState() {
        ...
        if (node != null) {
            ...
            if (propertyType == PropertyNodeType.ELEMENT
                    || propertyType == PropertyNodeType.ATTRIBUTE) {
                enabled = true;
            }
        }
