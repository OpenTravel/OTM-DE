...
import com.sabre.schemas.wizards.MergeContextNodeWizard;
...
public class DefaultContextController extends OtmControllerBase implements ContextController {
     ...
     * 
     * @see
     * com.sabre.schemas.controllers.ContextController#getDefaultContextId(com.sabre.schemas.node
     * .LibraryNode)
     */
    @Override
     ...
     * 
     * @see
     * com.sabre.schemas.controllers.ContextController#getApplicationContext(com.sabre.schemas.node
     ...
     * 
     * @see
     * com.sabre.schemas.controllers.ContextController#getSelectedId(com.sabre.schemas.controllers
     * .DefaultContextController.ContextViewType, com.sabre.schemas.node.LibraryNode)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.controllers.ContextController#clearContexts()
     */
    @Override
     ...
     * 
     * @see
     * com.sabre.schemas.controllers.ContextController#setSelectedId(com.sabre.schemas.controllers
     * .DefaultContextController.ContextViewType, com.sabre.schemas.node.LibraryNode,
     * java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.controllers.ContextController#editContext()
     */
    @Override
     ...
     * 
     * @see
     * com.sabre.schemas.controllers.ContextController#getContextNode(com.sabre.schemas.node.LibraryNode
     * , java.lang.String)
     */
    @Override
     ...
     * 
     * @see
     * com.sabre.schemas.controllers.ContextController#getDefaultContextNode(com.sabre.schemas.node
     * .ContextNode)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.controllers.ContextController#cloneContext()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.controllers.ContextController#copyContext()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.controllers.ContextController#copyContext(com.sabre.schemas.node.Node,
     * com.sabre.schemas.node.LibraryNode)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.controllers.ContextController#setDefaultContext()
     */
    @Override
