...
public class DefaultDocumentationController implements DocumentationController {
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.controllers.DocumentationController#addDocItem()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.controllers.DocumentationController#deleteDocItem()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.controllers.DocumentationController#upDocItem()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.controllers.DocumentationController#downDocItem()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.controllers.DocumentationController#clearDocItem()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.controllers.DocumentationController#changeDocItemType()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sabre.schemas.controllers.DocumentationController#cloneDocItems()
     */
    @Override
