...
import com.sabre.schemas.widgets.ErrorWithExceptionDialog;
...
import com.sabre.schemas.wizards.ChangeWizard;
import com.sabre.schemas.wizards.NewFacetValidator;
import com.sabre.schemas.wizards.NewFacetWizard;
...
public class MainController {
    ...
    public void runDeleteNode(Event event) {
        String cmd = "com.sabre.schemas.commands.DeleteNode";
        runCommand(cmd, event);
    }
    ...
    public void runSaveLibraries(Event event) {
        String cmd = "com.sabre.schemas.commands.SaveLibraries";
        runCommand(cmd, event);
    }
