...
import com.sabre.schemas.actions.AddContextAction;
import com.sabre.schemas.actions.CloneContextAction;
import com.sabre.schemas.actions.MergeContextAction;
import com.sabre.schemas.actions.SetContextAsDefaultAction;
...
import com.sabre.schemas.trees.context.ContextTreeContentProvider;
import com.sabre.schemas.trees.context.ContextTreeLabelProvider;
 ...
 * 
 */
public class ContextsView extends OtmAbstractView implements ISelectionListener,
    ...
    public static String VIEW_ID = "com.sabre.schemas.stl2Developer.ContextsView";
    ...
    public void createPartControl(final Composite parent) {
        ...
        getSite().getPage().addSelectionListener(
                "com.sabre.schemas.stl2Developer.ModelNavigatorView", this);
        ...
        addContextAction = new AddContextAction(mainWindow, new ExternalizedStringProperties(
                "action.addContext"));
        cloneContextAction = new CloneContextAction(mainWindow, new ExternalizedStringProperties(
                "action.cloneContext"));
        mergeContextAction = new MergeContextAction(mainWindow, new ExternalizedStringProperties(
                "action.mergeContext"));
    ...
    private TreeViewer initializeTreeViewer(Composite parent) {
        ...
        viewer.addDragSupport(DND.DROP_COPY | DND.DROP_MOVE,
                new Transfer[] { TextTransfer.getInstance() }, new DragSourceListener() {
