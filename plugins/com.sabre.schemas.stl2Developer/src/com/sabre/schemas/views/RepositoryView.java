...
import com.sabre.schemas.trees.repository.RepositoryMenus;

/**
 * 
 * Present a view of the repositories. Uses Repository Manager as its primary model. Uses Repository
...
public class RepositoryView extends OtmAbstractView implements ISelectionListener,
        ISelectionChangedListener, ITreeViewerListener {

    public static final String VIEW_ID = "com.sabre.schemas.stl2Developer.RepositoryView";
    ...
    public List<Node> getSelectedNodes() {
        if (!getMainWindow().hasDisplay() && curNode != null) {
            ...
            return new ArrayList<Node>(curNode.getLibrary().getDescendants_NamedTypes());
        }
