 ...
 * 
 */
public class DownDocItemAction extends OtmAbstractAction {

    /**
	 *
	 */
    public DownDocItemAction(final MainWindow mainWindow, final StringProperties props) {
    ...
    public void run() {
        ...
        if (view != null) {
            view.getDocumentationController().downDocItem();
        }
    }
