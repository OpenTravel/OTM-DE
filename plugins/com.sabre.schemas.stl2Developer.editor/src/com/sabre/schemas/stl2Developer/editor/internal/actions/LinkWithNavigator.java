...
import com.sabre.schemas.stl2Developer.editor.commands.HideAllNodesCommand;
import com.sabre.schemas.stl2Developer.editor.internal.Features;
import com.sabre.schemas.stl2Developer.editor.parts.ComponentNodeEditPart;
import com.sabre.schemas.stl2Developer.editor.view.DependeciesView;
    ...
    class NavigatorSelectionListener implements ISelectionListener {
        ...
        private Command getCreateCommand(final Node newNode) {
            ...
            if (view.getGraphicalViewer().getControl() != null) {
                org.eclipse.swt.graphics.Point size = view.getGraphicalViewer().getControl()
                        .getSize();
                location = new Point(size.x / 2 - 100, 10);
            }
            create.setLocation(location);
            EditPart target = view.getGraphicalViewer().getRootEditPart().getContents()
                    .getTargetEditPart(create);
